...
public class DBHelper {
     ...
     * @param sql    1
     * @param params 2
     * @Description: insert Cloudscape:相当于selectKey的SQL为： VALUES IDENTITY_VAL_LOCAL()
     * DB2:相当于selectKey的SQL为： VALUES IDENTITY_VAL_LOCAL() DB2_MF:相当于selectKey的SQL为：SELECT
     * IDENTITY_VAL_LOCAL() FROM SYSIBM.SYSDUMMY1 Derby:相当于selectKey的SQL为：VALUES IDENTITY_VAL_LOCAL()
     ...
     * LAST_INSERT_ID() SqlServer:相当于selectKey的SQL为：SELECT SCOPE_IDENTITY()
    ...
    public static <T> T queryBean(Class<T> clazz, String sql, Object... params) {
        return DBHelper.query(
            sql, new BeanHandler<>(clazz, new BasicRowProcessor(new GenerousBeanProcessor())), params);
    }
