...
public class CryptocurrencyBean {
  ...
  @JsonProperty private String customHeader;
  private String httpHeader;
  @JsonProperty private String coinMarketCapIDMap;
  @JsonProperty private String metadata;
  @JsonProperty private String latestlistings;
  @JsonProperty private String historicalListings;
  @JsonProperty private String latestQuotes;
  @JsonProperty private String historicalQuotes;
  @JsonProperty private String latestMarketPairs;
  @JsonProperty private String latestOHLCV;
  @JsonProperty private String historicalOHLCV;
  @JsonProperty private String pricePerformanceStats;
