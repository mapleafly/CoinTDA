...
public class InitTable {
    ...
    public void createTable() {
        ...
        sql = "CREATE TABLE TAB_TRADEDATA ("
                + "TD_ID int generated by default as identity,"
                + "TD_COINTYPE VARCHAR(10) NOT NULL,"
                + "TD_SALEORBUY VARCHAR(10) NOT NULL,"
                + "TD_PRICE DECIMAL(9,2) NOT NULL,"
                + "TD_NUM DECIMAL(22,8) NOT NULL,"
